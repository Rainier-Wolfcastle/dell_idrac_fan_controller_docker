...
function calculate_interpolated_fan_speed() {
  ...
  local -r RETURN_FAN_SPEED_A=$(( ($LOCAL_DECIMAL_HIGH_FAN_SPEED - $LOCAL_DECIMAL_FAN_SPEED) * ($highest_CPU_temperature - $CPU_TEMPERATURE_THRESHOLD_FOR_FAN_SPEED_INTERPOLATION) ))
  local -r RETURN_FAN_SPEED_B=$(( ($CPU_TEMPERATURE_THRESHOLD - $CPU_TEMPERATURE_THRESHOLD_FOR_FAN_SPEED_INTERPOLATION) ))
  ...
  #RETURN_FAN_SPEED=$(( LOCAL_DECIMAL_FAN_SPEED + ( RETURN_FAN_SPEED_A / RETURN_FAN_SPEED_B ) ))
